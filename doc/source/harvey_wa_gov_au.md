...
*(boolean) (optional, default: 	rue)*

Set to 	rue if your recycling bin is collected on even ISO week numbers, alse if collected on odd ISO week numbers. Check your last recycling collection date to determine this (use a site like [whatweekisit.org](https://whatweekisit.org/)).
...
3. To determine 
ecycling_in_even_week: note the date of your last recycling collection, look up its ISO week number (e.g. using [whatweekisit.org](https://whatweekisit.org/)), and set the value to 	rue if even, alse if odd.
