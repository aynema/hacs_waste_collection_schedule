...
3. To determine recycling_in_even_week: note the date of your last recycling collection, look up its ISO week number (Se.g. using [whatweekisit.org](https://whatweekisit.org/)), and set the value to True if even, False if odd.
